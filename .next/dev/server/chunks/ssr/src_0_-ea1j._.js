...
function AdminOrdersPage() {
    ...
    const getBatchBadgeWithFlag = (batchName)=>{
        if (/[\u{1F1E6}-\u{1F1FF}]{2}/u.test(batchName)) {
            return batchName;
        }
        ...
        if (ord.items && Array.isArray(ord.items)) {
            ord.items.forEach((item)=>{
                ...
                if (item.status !== 'failed') {
                    groupedOrders[groupKey].total_amount += (item.price || 0) * (item.quantity || 1);
                }
            });
        }
    });
    ...
    const handleArchiveOrder = async (orderIds)=>{
        if (!confirm('確定要封存此訂單嗎？封存後將從訂單管理中移除，僅保留於批次管理中。')) return;
    ...
    const copyPaymentNotice = (g)=>{
        ...
        text += `🏦 匯款轉帳資訊：\n銀行：822 中國信託\n帳號：1234-5678-9012\n戶名：林星妤\n\n`;
        text += `匯款完成後，請點開前台「會員中心」填寫您的「帳號後五碼」與「7-11 寄件門市（0 元包裹純取貨）」，謝謝您！`;
        navigator.clipboard.writeText(text);
    ...
    const printShippingLabel = (g)=>{
        ...
        if (!printWindow) return alert('請允許瀏覽器彈出視窗以進行列印');
        const itemsHtml = g.items.filter((i)=>i.status !== 'failed').map((i)=>`<li>${i.name} ${i.selectedVariant ? `(${i.selectedVariant})` : ''} × ${i.quantity}</li>`).join('');
        printWindow.document.write(`
      <html>
        <head>
          <title>出貨包裝核對單 - ${g.buyer_name || g.line_name}</title>
          <style>
            body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; padding: 24px; color: #111; }
            .label-box { border: 2px solid #000; border-radius: 8px; padding: 20px; max-width: 440px; margin: 0 auto; }
            ...
            .type { font-size: 13px; font-weight: bold; background: #eee; padding: 4px 8px; border-radius: 4px; }
            .field { margin-bottom: 12px; font-size: 14px; line-height: 1.5; }
            .field strong { font-size: 12px; color: #555; display: block; }
            .field span { font-size: 16px; font-weight: bold; }
            .items { border-top: 1px dashed #999; padding-top: 12px; margin-top: 16px; font-size: 13px; }
        ...
        <body>
          <div class="label-box">
            <div class="header">
              <div class="title">一条魚代購・出貨核對單</div>
              <div class="type">7-11 純取貨</div>
            </div>
            <div class="field">
              <strong>7-11 取件門市與店號</strong>
              <span>${g.store_name || '未提供'}</span>
            </div>
            <div class="field">
              <strong>收件人姓名 (核對證件)</strong>
              <span>${g.buyer_name || g.line_name}</span>
            </div>
            <div class="field">
              <strong>收件人電話</strong>
              <span>${g.buyer_phone || '未提供'}</span>
            </div>
            <div class="field">
              <strong>連線批次 / 買家 LINE</strong>
              <span>${g.batch_name}（LINE: ${g.line_name}）</span>
            </div>
            <div class="items">
              <strong>包裹商品內容：</strong>
              <ul>${itemsHtml}</ul>
            </div>
          </div>
          <script>
    ...
    const handleRevertPayment = async (orderIds)=>{
        if (!confirm('確定要將此訂單移回「待入帳」嗎？')) return;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').update({
            pay_status: 'reported'
        }).in('id', orderIds);
        if (!error) fetchData();
    ...
    const handleRevertToShipping = async (orderIds)=>{
        if (!confirm('確定將此訂單移回「準備出貨」嗎？')) return;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').update({
            status: 'bought'
        }).in('id', orderIds);
        if (!error) fetchData();
    ...
    const handleRevertToShipped = async (orderIds)=>{
        if (!confirm('確定將此訂單移回「已出貨」嗎？')) return;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('orders').update({
            status: 'shipped'
        }).in('id', orderIds);
        if (!error) fetchData();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-slate-900 border border-slate-800 px-5 py-2.5 rounded-2xl flex items-center gap-3",
                                children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-right pl-3 border-l border-slate-800",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: g.items.map((it, idx)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: `p-3.5 rounded-2xl border flex items-center justify-between text-xs md:text-sm ${isFailed ? 'bg-slate-950/40 border-slate-800/40 opacity-50' : 'bg-slate-950 border-slate-800/80'}`,
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: `font-mono text-sm ${isFailed ? 'line-through text-slate-500' : 'text-slate-300'}`,
                                                        children: [
                                                            "NT$ ",
